...
This is the VB.NET version. We also offer a [C# version](https://github.com/AtalaSupport/DemoGallery_Desktop_CustomOcrTranslatorDemo_CS__x64) 
...
```bash
git clone https://github.com/AtalaSupport/DemoGallery_Desktop_CustomOcrTranslatorDemo_VB_x64.git CustomOcrTranslatorDemo --recursive
